...
namespace Wox.Plugin.VirtualBox {
    /// <summary>
    /// This is just a copy of the FuzzyMatcher from the Wox source (https://github.com/Wox-launcher/Wox/blob/master/Wox.Infrastructure/FuzzyMatcher.cs).
    /// If Wox.Infrastructure ever gets exposed (see https://github.com/Wox-launcher/Wox/issues/364), we'll be able to get rid of this copypasta.
    /// </summary>
